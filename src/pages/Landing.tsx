...
const Landing = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-secondary">
        ...
        <div className="container mx-auto px-4 pt-20 pb-32 relative">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-6 py-2 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <span className="text-sm font-medium text-primary">Workbook for Christian Stewards</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
              A beautiful, faith-centered digital workbook to steward your spiritual giving, 
              personal growth, and financial goals with purpose and clarity.
            </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Track what matters most with purpose-built tools for spiritual, personal, and financial stewardship.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-card rounded-2xl p-8 shadow-elegant border border-border hover:shadow-gold transition-smooth">
              ...
              <h3 className="text-2xl font-serif font-bold mb-4">God's Will Vision</h3>
              <p className="text-muted-foreground leading-relaxed">
                Track your spiritual giving habits, commitments, and worship-focused goals. 
                Honor your tithes, offerings, and sacrificial giving with intentionality.
              </p>
            </div>
            ...
            <div className="bg-card rounded-2xl p-8 shadow-elegant border border-border hover:shadow-gold transition-smooth">
              ...
              <h3 className="text-2xl font-serif font-bold mb-4">Personal Vision</h3>
              <p className="text-muted-foreground leading-relaxed">
                Cultivate character and build Christ-centered habits. Track commitments, 
                break old patterns, and celebrate every step of transformation.
              </p>
            </div>
            ...
            <div className="bg-card rounded-2xl p-8 shadow-elegant border border-border hover:shadow-gold transition-smooth">
              ...
              <h3 className="text-2xl font-serif font-bold mb-4">Financial Vision</h3>
              <p className="text-muted-foreground leading-relaxed">
      ...
      {/* CTA */}
      <section className="py-20 container mx-auto px-4">
        <div className="max-w-4xl mx-auto bg-gradient-primary rounded-3xl p-12 text-center shadow-elegant">
          ...
          <p className="text-xl text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
            Start stewarding your visions today with daily trackers, progress charts, 
